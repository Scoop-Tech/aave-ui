...
export const themes: Themes = {
  default: {
    ...
    primary: { hex: '#2CFF04', rgb: [44, 255, 4] },
    secondary: { hex: '#FFE600', rgb: [255, 230, 0] },
    darkBlue: { hex: '#222222', rgb: [56, 61, 81] },
    textDarkBlue: { hex: '#222222', rgb: [56, 61, 81] },
  ...
  dark: {
    ...
    whiteElement: { hex: '#222222', rgb: [56, 61, 81] },
    whiteItem: { hex: '#333333', rgb: [0, 0, 0] },
    darkOrange: { hex: '#f0650a', rgb: [240, 101, 10] }, // for deposit APY
    gray: { hex: '#707070', rgb: [112, 112, 112] },
    lightGray: { hex: '#a2a2a2', rgb: [162, 162, 162] },
